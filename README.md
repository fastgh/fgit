...
## 使用：
   ...
   - <font color="blue">和常规的git命令行几乎相同，支持各种命令行参数，也就是说，平时git命令行怎么用，fgit就怎么用，区别只是git换成了fgit。</font>
...
## 问题反馈和交流：
   ...
   <img src="https://control.fastgithub.com:10443/static/wechat_contact.png" alt="image" style="zoom:50%;"/>
